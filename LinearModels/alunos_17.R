...
names(TS_ALUNO_9EF)[37:93] <- paste0("Q",1:57)
...
load("estruturaEscola_2017.RDS")

data_17 <- merge(data,escolas_9EF_17)

# Select variáveis
data_17 <- data_17 %>% select(ID_ALUNO,ID_TURMA,ID_ESCOLA,ID_TURNO,
...
save(data_17, file="data_11.RDS") # only students infos

load("estruturaEscola_2011.RDS")
data_17 <- merge(data_17,escolas_17) 

save(data_17,file="data_17_compl.RDS") # students and schools infos

...
load("estruturaEscola_2013.RDS")

data_13 <- merge(data,escolas_9EF_13)

# Select variáveis
data_13 <- data_13 %>% select(ID_ALUNO,ID_TURMA,ID_ESCOLA,ID_TURNO,
...
save(data_13, file="data_11.RDS") # only students infos

load("estruturaEscola_2011.RDS")
data_13 <- merge(data_13,escolas_13) 

save(data_13,file="data_13_compl.RDS") # students and schools infos
